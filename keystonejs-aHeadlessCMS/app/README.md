...
``` bash
$ npm init keystone-app app
$ cd app
app$ npm run dev
```

Browser `localhost:3000` and set first user.

### 2. Directory Structure

```
/
|- /.keystone/admin    # IGNORE. web ui is automatically generated, 
|- auth.ts             # admin implement by keystonejs
|- keystone.db         # IGNORE. sqlite file. 
|- keystone.ts         # Program entry point. Keystone config
|- schema.graphql      # graphql is automatically generated.
|- schema.prisma       # prismais automatically generated.
|- schema.ts           # business program file
```
